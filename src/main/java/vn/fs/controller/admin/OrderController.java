...
public class OrderController {
	...
	@GetMapping(value = "/orderscxn")
	public String orderscxn(Model model, Principal principal) {

		List<Order> orderDetails = orderRepository.fileOderCXN();
		model.addAttribute("orderDetails", orderDetails);

		return "admin/orderscxn";
	}

	@GetMapping(value = "/orderscgh")
	public String orderscgh(Model model, Principal principal) {

		List<Order> orderDetails = orderRepository.fileOderCGH();
		model.addAttribute("orderDetails", orderDetails);

		return "admin/orderscgh";
	}

	@GetMapping(value = "/ordersdtt")
	public String orderdtt(Model model, Principal principal) {

		List<Order> orderDetails = orderRepository.fileOderDTT();
		model.addAttribute("orderDetails", orderDetails);

		return "admin/ordersdtt";
	}
	...
	@GetMapping(value = "/exportcxn")
	public void exportToExcelcxn(HttpServletResponse response) throws IOException {

		response.setContentType("application/octet-stream");
		String headerKey = "Content-Disposition";
		String headerValue = "attachement; filename=orders_choxacnhan.xlsx";

		response.setHeader(headerKey, headerValue);

		List<Order> lisOrders = orderRepository.fileOderCXN();
	...
	@GetMapping(value = "/exportcgh")
	public void exportToExcelcgh(HttpServletResponse response) throws IOException {

		response.setContentType("application/octet-stream");
		String headerKey = "Content-Disposition";
		String headerValue = "attachement; filename=orders_chogiaohang.xlsx";

		response.setHeader(headerKey, headerValue);

		List<Order> lisOrders = orderRepository.fileOderCGH();
	...
	@GetMapping(value = "/exportdtt")
	public void exportToExceldtt(HttpServletResponse response) throws IOException {

		response.setContentType("application/octet-stream");
		String headerKey = "Content-Disposition";
		String headerValue = "attachement; filename=orders_dathanhtoan.xlsx";

		response.setHeader(headerKey, headerValue);

		List<Order> lisOrders = orderRepository.fileOderDTT();
